...
{   
    ...
    [DataContext(typeof(OrderDbContext), DbConnectionString.OrderDbConnection)]
    public class OCommodity : Commodity, IRelationable
    {
        [Get] public string OrderId { get; set; }
        [Get] public string OrderedAt { get; set; }
        ...
        [Get] public string OrderType {get; set;}
        [Detail][Many(ViewNameofOrderCenter.SOCommodity)]public List<SOCommodity> SOCommodities {get; set;}
        [Detail][Many(ViewNameofOrderCenter.MOCommodity)]public List<MOCommodity> MOCommodities {get; set;}
        [Detail][Many(ViewNameofOrderCenter.EOCommodity)]public List<EOCommodity> EOCommodities {get; set;}
    ...
    [Relation(typeof(SOCommodity), "OOS")]
    [DataContext(typeof(OrderDbContext), DbConnectionString.OrderDbConnection)]
    public class SOCommodity : SStatus, IRelationable
    {
    ...
    [Relation(typeof(MOCommodity), "OOM")]
    [DataContext(typeof(OrderDbContext), DbConnectionString.OrderDbConnection)]
    public class MOCommodity : MStatus, IRelationable
    {
        [Detail]public OCommodity OCommodity {get; set;}
        [Detail]public OrderCenter OrderCenter {get; set; }
    ...
    [Relation(typeof(EOCommodity), "OOE")]
    [DataContext(typeof(OrderDbContext), DbConnectionString.OrderDbConnection)]
    public class EOCommodity : EStatus, IRelationable
    {
