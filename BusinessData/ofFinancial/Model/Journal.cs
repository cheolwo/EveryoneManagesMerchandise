...
namespace BusinessData.ofFinancial.Model
{
    ...
    public class UserSettingJournal : Entity, IRelationable
    {
    ...
    [DataContext(typeof(JournalDbContext), DbConnectionString.JournalDbConnection)]
    public class JournalCenter : Center , IRelationable
    {
        [Required] public string b_no { get; set; } // 사업자등록번호
        [Required] public string start_dt { get; set; } // 개업일자
        [Required] public string p_nm { get; set; } // 대표자성명
...
*            등록되지 않았거나 삭제된 경우: "국세청에 등록되지 않은 사업자등록번호입니다"
    ...
    [DataContext(typeof(JournalDbContext), DbConnectionString.JournalDbConnection)]
    public class JCommodity : Commodity, IRelationable
    {
    ...
    [DataContext(typeof(JournalDbContext), DbConnectionString.JournalDbConnection)]
    public class Journal : Entity, IRelationable
    {
        public List<Debit> Debits { get; set; }         // Json 으로 처리한다.
        public List<Credit> Credits {get; set; }       // Json 으로 처리한다.
        public string AwesomeInfo {get; set;}
