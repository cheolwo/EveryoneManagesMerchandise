...
namespace BusinessData.ofProduct
{
    ...
    public class ProductLand : Entity, IRelationable, ITablable
    {
        public ProductLand()
        {
            Producter = new();
        }
        [Get]public string LandCode {get; set;}
        [Get]public string Address {get; set;}
        [Get]public string AreaofProductLand {get; set;}
        [Detail]public string AreaofRestProductLand {get; set;}
        [Get]public string PlantationType {get; set;}
        [Get]public string AreaofPlantation {get; set;}
        [Detail]public string LandBookCode {get; set;}
        ...
        // 농지주소, 경작형태, 농지소유자, 공부 및 실제 농지면적, 휴경면적
        // 노지/시설, 재배면적, 대장구분 코드
