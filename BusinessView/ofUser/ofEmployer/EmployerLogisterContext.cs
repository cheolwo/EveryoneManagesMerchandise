...
{
    public class EmployerLogisterContext : EmployerActorContext, IActorViewService<EmployerWarehouse>, IActorViewService<EmployerDividedTag>
    ...
    {
        public EmployerLogisterContext()
        {
