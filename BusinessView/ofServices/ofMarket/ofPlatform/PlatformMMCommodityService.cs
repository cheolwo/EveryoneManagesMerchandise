...
namespace BusinessView.ofCommon.ofServices.ofMarket.ofPlatform
{
    public class PlatformMMCommodityService : MarketService, IDTOService<PlatformMMCommodity>
    {
        ...
        public async Task<PlatformMMCommodity?> GetAsync(string id)
        {
        ...
        public async Task PostAsync(PlatformMMCommodity entity)
        {
        ...
        public async Task UpdateAsync(PlatformMMCommodity entity)
        {
            var entityJson = new StringContent(
            JsonSerializer.Serialize(entity),
            Encoding.UTF8,
