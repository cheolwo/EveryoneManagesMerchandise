...
namespace BusinessView.ofCommon.ofServices.ofOrder.ofEmployer
{
    public class EmployerMOCommodityService : OrderService, IDTOService<EmployerMOCommodity>
    {
        ...
        public async Task<EmployerMOCommodity?> GetAsync(string id)
        {
        ...
        public async Task PostAsync(EmployerMOCommodity entity)
        {
        ...
        public async Task UpdateAsync(EmployerMOCommodity entity)
        {
            var entityJson = new StringContent(
            JsonSerializer.Serialize(entity),
            Encoding.UTF8,
