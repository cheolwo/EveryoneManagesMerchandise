...
//namespace BusinessView.ofManager.ofFisheries
//{
...
//        {
//            var Fisheries = await _CenterDataRepository.GetToListWithCommoditiesAsync();
//            List<HttpRequestMessage> httpRequestMessages = new();
//            foreach (var center in Fisheries)
//            {
...
//            if (IsIn)
//            {
//                var Fisheries = await _CenterDataRepository.GetToListWithSStatusesAsync();
//                List<HttpRequestMessage> httpRequestMessages = new();
//                foreach (var center in Fisheries)
//                {
//                    Copartnership copartnership = await _entityDataRepostiroy.GetByCodeAsync(center.Code);
...
//            else
//            {
//                var Fisheries = await _CenterDataRepository.GetToListWithEStatusesAsync();
//                List<HttpRequestMessage> httpRequestMessages = new();
//                foreach (var center in Fisheries)
//                {
//                    Copartnership copartnership = await _entityDataRepostiroy.GetByCodeAsync(center.Code);
